...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\Huge Bronson Lim \vspace{2pt}} & % row = 1, col = 1
  Location: Crestline, CA\\ % row = 1, col = 2
  ...
  Email: \href{mailto:bronsoncl@gmail.com}{\uline{bronsoncl@gmail.com}} $|$ % row = 2, col = 2
  Mobile: 760-680-6303 \\ % row = 2, col = 2
\end{tabular*}
%--------------------------------------------
...
\section{Objective}
\small{
  Mathematics professor specializing in computational algebraic geometry looking
  to transition into data science and currently taking preliminary courses for
  an M.A. degree in Computer Science.
}
%--------------------------------------------
...
\resumeHeadingListStart{}
  \resumeQuadHeading{Assistant Professor}{Aug 2020 -- Present}
  {California State University San Bernardino}{San Bernardino, CA}
    \resumeItemListStart{}
		\resumeItem{Taught a variety of undergraduate/graduate mathematics
		courses including discrete mathematics for computer science
		undergraduates, linear algebra, and real analysis.}
		\resumeItem{Supervised several undergraduate research projects including
		infectious disease modelling, lattice cryptography, and elliptic curve
		cryptography.}
		\resumeItem{Co-Chair of the Departmental Assessment Committee:
		designing/scoring/interpretting annual assessment tasks given to our
		undergraduate mathematics students.}
    \resumeItemListEnd{}

  \resumeQuadHeading{Research Assistant Professor}{July 2017 -- July 2020}
  {University of Utah}{Salt Lake City, UT}
    \resumeItemListStart{}
		\resumeItem{Taught primarily multivariate calculus and (multivariate) real analysis
		undergraduate courses.}
		\resumeItem{Supervised two undergraduate reading courses including one
		on topological data analysis.}				
    \resumeItemListEnd{}

  \resumeQuadHeading{Graduate Teaching Fellow}{Sep 2011 -- June 2017}
  {University of Oregon}{Eugene, OR}
    \resumeItemListStart{}
		\resumeItem{Taught a variety of undergraduate course including three
		sections of statistics, linear algebra, and discrete mathematics. The
		statistics sections included hypothesis testing.}
    \resumeItemListEnd{}
...
\section{Education}
  \resumeHeadingListStart{}
  	\resumeQuadHeading{California State University San Bernardino}{San
	Bernardino, CA}
	{Transitory Student in Computer Science}{Aug 2022 -- Present}
  	\resumeQuadHeading{University of Oregon}{Eugene, OR}
    {Doctorate of Philosophy in Mathematics}{Sep 2011 -- June 2017}
	\resumeQuadHeading{California State University San Bernardino}{San
	Bernardino, CA}
	{Masters of Arts and Bachelors of Science in Mathematics}{Sep 2005 -- June 2011}
  \resumeHeadingListEnd{}
%---------------------------------------------
...
\section{Selected Publications}
  \resumeItemListStart{}
  \resumeItem{\bibentry{LR}}
  \resumeItem{\bibentry{L-thesis}}
  \resumeItem{\bibentry{LP}}
  \resumeItem{\bibentry{LH}}
  \resumeItemListEnd{}
%--------------------------------------------
\section{Technical Skills}
  \resumeHeadingListStart{}
  	\resumeSectionType{Languages}{:}{C++, SageMATH (Python), HTML, \LaTeX}
	\resumeSectionType{Statistical}{:}{Hypothesis Testing}
    \resumeSectionType{Dev Tools}{:}{Linux, Vim, Git, GitHub}
  \resumeHeadingListEnd{}
